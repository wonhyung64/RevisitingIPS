...
# "$TASK/escm2_ips.py --depth=0 --embedding-k=64 --base-model=ncf --dataset-name=KuaiRec --batch-size=8192 --lr=1e-4 --weight-decay=1e-4 --lambda1=0.001 --lambda2=0.1" # fin
# "$TASK/escm2_naive.py --depth=0 --embedding-k=64 --base-model=ncf --dataset-name=KuaiRec --batch-size=8192 --lr=1e-3 --weight-decay=1e-6 --lambda1=2. --lambda2=0.01" # fin
# "$TASK/naive_v2.py --depth=0 --embedding-k=64 --base-model=ncf --dataset-name=KuaiRec --batch-size=8192 --lr=1e-4 --weight-decay=1e-6 --lambda1=2. --lambda2=0.001 --lambda3=0.1" # fin
"$TASK/ips_v2.py --depth=0 --embedding-k=64 --base-model=ncf --dataset-name=KuaiRec --batch-size=8192 --lr=1e-4 --weight-decay=1e-5 --lambda1=2. --lambda2=1. --lambda3=1." # fin


#mf 
# "$TASK/ips.py --embedding-k=64 --base-model=mf --dataset-name=KuaiRec --batch-size=8192 --lr=1e-4 --weight-decay=1e-6" # fin
# "$TASK/naive.py --embedding-k=64 --base-model=mf --dataset-name=KuaiRec --batch-size=8192 --lr=1e-4 --weight-decay=1e-6" # fin

# cv1 running
# "$TASK/akb_ips.py --embedding-k=64 --base-model=mf --dataset-name=KuaiRec --batch-size=8192 --lr=1e- --weight-decay=1e- --G=1 --lr2=0.05 --lr3=0.05 --J=3 --gamma=1. --C=1e-5 --lamb2=0. --lamb3=0."

# cv1
# "$TASK/multi_naive.py --embedding-k=64 --base-model=mf --dataset-name=KuaiRec --batch-size=8192 --lr=1e- --weight-decay=1e- --lambda1="
# "$TASK/esmm.py --embedding-k=64 --base-model=mf --dataset-name=KuaiRec --batch-size=8192 --lr=1e- --weight-decay=1e- --lambda1="
# "$TASK/multi_ips.py --embedding-k=64 --base-model=mf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e- --weight-decay=1e- --lambda1="
# "$TASK/escm2_ips.py --embedding-k=64 --base-model=mf --dataset-name=KuaiRec --batch-size=8192 --lr=1e- --weight-decay=1e- --lambda1= --lambda2=" 
# "$TASK/escm2_naive.py --embedding-k=64 --base-model=mf --dataset-name=KuaiRec --batch-size=8192 --lr=1e- --weight-decay=1e- --lambda1= --lambda2=" 


# cv2
# "$TASK/ips_v2.py --embedding-k=64 --base-model=mf --dataset-name=KuaiRec --batch-size=8192 --lr=1e-4 --weight-decay=1e-6 --lambda1=2. --lambda2= --lambda3=" 
# "$TASK/naive_v2.py --embedding-k=64 --base-model=mf --dataset-name=KuaiRec --batch-size=8192 --lr=1e-4 --weight-decay=1e-6 --lambda1=1. --lambda2= --lambda3=" 
