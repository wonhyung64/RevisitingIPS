...
class LinearCFPlus(nn.Module):
    """
    Linear Collaborative Filtering for Treated and ontrolled
    """
    def __init__(self, num_users:int, num_items:int, embedding_k:int):
...
class SharedLinearCFPlus(nn.Module):
    """
    Linear Collaborative Filtering for Treated and Controlled with Embedding Sharing
    """
    def __init__(self, num_users:int, num_items:int, embedding_k:int):
...
class LinearCF_AKBIPS_ExpPlus(nn.Module):
    """
    AKB-IPS with Linear Collaborative Filtering for Treated and Controlled
    """
    def __init__(self, num_users:int, num_items:int, embedding_k:int=4, *args, **kwargs):
        super().__init__()
        self.num_users = num_users
