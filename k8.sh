...
# "--embedding-k=8 --depth=0 --loss-type=naive --base-model=ncf --dataset-name=coat --batch-size=4096 --lr=1e-4 --weight-decay=1e-4 --lambda1=0.01"
# "--embedding-k=8 --depth=0 --loss-type=naive --base-model=ncf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e-2 --weight-decay=1e-4 --lambda1=0.1"

# "--embedding-k=8 --loss-type=naive --base-model=mf --dataset-name=coat --batch-size=4096 --lr=1e-2 --weight-decay=1e-5 --lambda1=1."
# "--embedding-k=8 --loss-type=naive --base-model=mf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e-4 --weight-decay=1e-6 --lambda1=1."

"--embedding-k=8 --depth=2 --loss-type=naive --base-model=ncf --dataset-name=coat --batch-size=4096 --lr=1e-4 --weight-decay=1e-4 --lambda1=0.01"
"--embedding-k=8 --depth=2 --loss-type=naive --base-model=ncf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e-3 --weight-decay=1e-5 --lambda1=2."

"--embedding-k=8 --depth=0 --loss-type=ips --base-model=ncf --dataset-name=coat --batch-size=4096 --lr=1e-4 --weight-decay=1e-4 --lambda1=0.001 "
"--embedding-k=8 --depth=0 --loss-type=ips --base-model=ncf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e-3 --weight-decay=1e-5 --lambda1=0.001"

# "--embedding-k=8 --loss-type=ips --base-model=mf --dataset-name=coat --batch-size=4096 --lr=1e-2 --weight-decay=1e-4 --lambda1=0.01"
# "--embedding-k=8 --loss-type=ips --base-model=mf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e-3 --weight-decay=1e-5 --lambda1=2."

# "--embedding-k=8 --depth=2 --loss-type=ips --base-model=ncf --dataset-name=coat --batch-size=4096 --lr=1e-4 --weight-decay=1e-4 --lambda1=0.001"
# "--embedding-k=8 --depth=2 --loss-type=ips --base-model=ncf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e-2 --weight-decay=1e-4 --lambda1=0.001"
...
for index in ${!experiments[*]}; do
    for index_l2 in ${!lambda2_options[*]}; do
        ...
        echo "Launching on GPU $GPU_ID: "
        echo $EXECUTION_FILE ${experiments[$index]} --data-dir=$TASK/data --random-seed=$RANDOM_SEED ${lambda2_options[$index_l2]} 
        $ENV $EXECUTION_FILE ${experiments[$index]} --data-dir=$TASK/data --random-seed=$RANDOM_SEED ${lambda2_options[$index_l2]} &
...
# "--embedding-k=8 --depth=0 --base-model=ncf --dataset-name=coat --batch-size=4096 --lr=1e-4 --weight-decay=1e-4 --lambda1=1."
...
# "--embedding-k=8 --base-model=mf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e-3 --weight-decay=1e-6 --lambda1=0.001"

# "--embedding-k=8 --depth=2 --base-model=ncf --dataset-name=coat --batch-size=4096 --lr=1e-4 --weight-decay=1e-4 --lambda1=0.01"
# "--embedding-k=8 --depth=2 --base-model=ncf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e-2 --weight-decay=1e-6 --lambda1=1."
...
# "--embedding-k=8 --depth=0 --base-model=ncf --dataset-name=coat --batch-size=4096 --lr=1e-3 --weight-decay=1e-4 --lambda1=1."
# "--embedding-k=8 --depth=0 --base-model=ncf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e-3 --weight-decay=1e-4 --lambda1=2."
