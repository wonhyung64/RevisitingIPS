...
#cv1 re
# "$TASK/naive.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=coat --batch-size=4096 --lr=1e- --weight-decay=1e-"
# "$TASK/esmm.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=coat --batch-size=4096 --lr=1e- --weight-decay=1e- --lambda1="
...
#cv1 re
# "$TASK/ips.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e- --weight-decay=1e-"
# "$TASK/naive.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e- --weight-decay=1e-"
# "$TASK/esmm.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e- --weight-decay=1e- --lambda1="
...
# running 7/13 22:16
# "$TASK/naive_v2.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=yahoo_r3 --batch-size=8192 --lr=1e-4 --weight-decay=1e-6"
...
# "$TASK/escm2_plus_ips.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=original --lr=1e-2 --weight-decay=1e-4 --lambda1=0.01 --lambda2=2. --propensity=pred"
# "$TASK/escm2_plus_naive.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=original --lr=1e-4 --weight-decay=1e-4 --lambda1=2. --lambda2=2."
# "$TASK/v2_plus_ips.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=original --lr=1e-2 --weight-decay=1e-4 --lambda1=0.001 --lambda2=2. --lambda3=0.01 --propensity=pred"
# "$TASK/v2_plus_naive.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=original --lr=1e-4 --weight-decay=1e-4 --lambda1=2. --lambda2=2. --lambda3=1."
...
# "$TASK/escm2_plus_ips.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=personalized --lr=1e-2 --weight-decay=1e-4 --lambda1=1. --lambda2=2. --propensity=pred"
# "$TASK/escm2_plus_naive.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=personalized --lr=1e-3 --weight-decay=1e-4 --lambda1=1. --lambda2=2."
# "$TASK/v2_plus_ips.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=personalized --lr=1e-2 --weight-decay=1e-4 --lambda1=1. --lambda2=2. --lambda3=1. --propensity=pred"
# "$TASK/v2_plus_naive.py --depth=0 --embedding-k=8 --base-model=ncf --dataset-name=personalized --lr=1e-2 --weight-decay=1e-5 --lambda1=1. --lambda2=2. --lambda3=1."
